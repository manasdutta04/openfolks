...
describe("Antigravity OpenFolks MCP config", () => {
  ...
  it("does not mount token-bearing OpenFolks tools in safe mode even when a caller supplies them", async () => {
    ensureDirs();
    chmodSync(FAKE_CLI, 0o755);
