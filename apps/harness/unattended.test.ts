...
posixOnly("unattended turns keep asking", () => {
    ...
    writeFileSync(
      ...
      JSON.stringify({
        instances: {
          ...
          // likelier one: a webhook folk pulling someone in for an answer
          asker: {
            driver: "grokAgent",
  ...
  it(
    ...
    async () => {
      ...
      // mark crossing the hop, the gate protects the folk that READ the
      // payload and releases the folk that ACTS on it.
