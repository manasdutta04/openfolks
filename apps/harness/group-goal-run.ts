...
export const GROUP_GOAL_CONTROL_OPEN = "<openfolks-goal>";
export const GROUP_GOAL_CONTROL_CLOSE = "</openfolks-goal>";
...
export function groupGoalWorkerInstructions(args: {
  ...
  return [
    ...
    `Address your result to ${args.coordinatorName}. Do not invent a new orchestration protocol or emit an openfolks-goal control envelope.`,
  ].join("\n");
}
