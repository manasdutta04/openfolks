...
export interface SendTurnInput {
  ...
  integrations?: {
    ...
    /** Cloud computer, reached through OpenFolks's REST-to-MCP adapter.
     ...
     * shows. One tab per folk, in its own persistent session partition. */
...
export interface ProviderAdapter {
  ...
  readonly capabilities: {
     ...
     * screenshot/click tools). Same rule as agentsMcp: a folk must never be
     ...
     * a folk must never be told it has a browser its driver cannot hand it. */
    browserMcp?: boolean;
     ...
     * attachment an engine cannot open (a folk told it has an image it
