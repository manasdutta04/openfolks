 ...
 * Gated on a prior USER turn: a new folk's thread is seeded with its own
...
const FRESH_PREAMBLE =
  "[You are joining this conversation mid-thread (the user switched this folk over to you). The conversation so far:]";
