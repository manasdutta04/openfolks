...
const LINUX_GUIDE_URL =
  "http://github.com/manasdutta04/openfolks/blob/main/docs/linux-desktop.md#enable-local-control";
      ...
      {waylandSafetyBlocked ? (
        ...
        <div className="mt-3 rounded-lg border border-warning/20 bg-warning/5 p-3">
          <div className="flex gap-2 text-[12px] leading-relaxed text-ink-secondary">
            ...
            <span>
              Enabling lets folks you explicitly assign to <strong className="font-medium text-ink">This computer</strong>{" "}
        ...
        <div className="mt-3 rounded-lg bg-panel p-3 text-[12px] text-ink-secondary">
          <div className="flex items-start gap-2">
            ...
            <span aria-live="polite">
              {ready
                ? "Ready for folks explicitly assigned to this computer. Folk actions use a private cursor, so your pointer stays under your control."
