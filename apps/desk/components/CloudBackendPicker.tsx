// The Box / Self-hosted VPS segmented control shown under Advanced cloud
// computers. One component, two homes (via ComputerDestinationPicker), so the
// copy and the disabled rules can never drift apart.
  ...
  return (
    <div className="rounded-lg bg-inset p-3">
      ...
      <div className="mt-0.5 text-[11.5px] text-ink-secondary">
        {value === "vps"
          ? "Use your managed VPS container."
          : "Box is the default hosted computer."}
      </div>
