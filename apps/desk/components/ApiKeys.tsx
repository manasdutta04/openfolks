...
const ELECTRON_CREDENTIAL: Record<ConfigSection, "boxToken"> = {
  box: "boxToken",
};
...
> = {
  box: {
    ...
    description: "Give folks an isolated remote Linux computer with a desktop and terminal.",
  ...
  return (
    <div>
      ...
      <div className="mb-1.5 text-[12px] leading-relaxed text-ink-secondary">
        SSH config alias for the Linux VPS. OpenFolks uses your normal SSH config and agent; it does not store keys or passwords.{" "}
        See the{" "}
        <a
          href="http://github.com/manasdutta04/openfolks/blob/main/docs/byo-vps.md"
          target="_blank"
          rel="noopener noreferrer"
