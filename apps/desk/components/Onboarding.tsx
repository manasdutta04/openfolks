...
// First-run onboarding: what's installed (live engine checks from the
// harness), and what the app may use (TCC). Every check is skippable —
    ...
    .map((instance) => ({
      ...
      readyNote:
        instance.access === "custom"
          ...
          : "Installed — ready to power folks.",
    }));
      ...
      >
        {step === 0 && (
          <div className="flex flex-col items-center">
            ...
            <button
              onClick={() => setStep(1)}
              className="mt-6 w-full rounded-lg bg-accent py-2.5 text-[15px] font-medium text-white"
            >
              Continue
            </button>
          </div>
        ...
        {step === 1 && (
          <div className="flex min-h-0 flex-col">
            ...
            <p className="mt-1 text-[13.5px] text-ink-secondary">
              Folks run on AI tools installed on this computer — here&rsquo;s what we found.
            </p>
