...
export const LOCAL_COMPUTER_AUTO_WARNING =
  "Auto mode will let this folk click, type, and run tools on this computer without asking first. Destructive and sensitive actions still stop. Continue only if you are watching.";
