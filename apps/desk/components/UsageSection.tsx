// App settings → Usage: what every bot has spent, so "which of my folks is
...
export function UsageSection() {
  ...
  return (
    <Card title="Usage" subtitle="Tokens and cost per folk, added up from every settled turn. Only engines that report a price show one.">
      {rows.length === 0 ? (
        <div className="text-[13px] text-ink-secondary">Nothing spent yet — figures appear after a folk's first turn.</div>
      ) : (
