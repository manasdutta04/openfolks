...
export const BOT_CHATS_SECTION_ID = "builtin:folk-chats";
...
export function sidebarSectionLabel(id: SidebarSectionId): string {
  ...
  if (id === BOT_CHATS_SECTION_ID) return "Folk Chats";
  if (id === BOTS_SECTION_ID) return "Folks";
...
export function sidebarLayoutInteractive(
  density: "comfortable" | "icons",
  query: string,
): boolean {
