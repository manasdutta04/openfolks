...
describe("local computer UI eligibility", () => {
  ...
  it("keeps the destination-picker Auto line short and local-first", () => {
    expect(simpleComputerAutoDescription()).toBe(
      "Auto picks Local VM or this computer when ready.",
    );
  });
