...
/** Short Auto line for the simplified destination picker. */
export function simpleComputerAutoDescription(): string {
  return "Auto picks Local VM or this computer when ready.";
}
