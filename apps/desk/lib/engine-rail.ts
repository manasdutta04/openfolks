...
/** Model engines only — Computer (Box) is a destination, not an LLM. */
export function isLlmEngine(instance: { driverKind?: string } | undefined): boolean {
  return Boolean(instance && instance.driverKind !== "boxAgent");
}
