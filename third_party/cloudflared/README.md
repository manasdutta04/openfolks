...
OpenFolks stages the official `cloudflared` 2026.8.2 executable as a separate
...
| OpenFolks target | Release asset | Release asset SHA-256 | Extracted executable SHA-256 |
| --- | --- | --- | --- |
...
The macOS release process applies OpenFolks's Developer ID signature to the
...
copy of that license at `resources/licenses/cloudflared-LICENSE.txt` (sourced
from `third_party/cloudflared/LICENSE`). OpenFolks itself is MIT-licensed.
