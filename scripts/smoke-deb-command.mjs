...
import { packageInstallCommand } from "../apps/shell/package-install-command.mjs";
...
const staged = "/root/pending dir/o'brien/OpenFolks.deb";
...
const installed = inContainer(
  [
    ...
    'test -x /opt/OpenFolks/openfolks && echo "EXECUTABLE=yes"',
  ].join("\n"),
);
