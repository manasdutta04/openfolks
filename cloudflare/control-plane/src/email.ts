...
const SUBJECTS = {
  "sign-in": "Your OpenFolks sign-in code",
  "email-verification": "Verify your OpenFolks email",
  "forget-password": "Reset your OpenFolks password",
  "change-email": "Confirm your OpenFolks email change",
...
export function buildOTPEmail(from: string, input: OTPEmailInput) {
  ...
  return {
    to: input.email,
    from: { email: from, name: "OpenFolks" },
    subject,
    html,
    text,
  };
